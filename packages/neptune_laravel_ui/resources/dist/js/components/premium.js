    ...
    constructor() {
        ...
        this.onClick = () => {
            if (this.hasAttribute("disabled"))
                return;
            this.dispatchEvent(new CustomEvent("npt-select", {
                bubbles: true,
                composed: true,
...
NptDockItem.observedAttributes = ["label", "active", "disabled"];
/**
...
export class NptOnboarding extends NptElement {
    ...
    render() {
        ...
        const dots = Array.from({ length: steps }, (_, i) => i === activeStep ? `<span class="dot" data-on></span>` : `<span class="dot"></span>`).join("");
        return html `
...
NptOnboarding.observedAttributes = ["eyebrow", "supporting", "steps", "active-step"];
/**
...
NptCta.observedAttributes = ["variant", "arrow", "disabled"];
