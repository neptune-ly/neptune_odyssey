...
NptCheckbox.observedAttributes = ["checked", "indeterminate", "disabled"];
...
export class NptRadio extends NptElement {
    ...
    select() {
        if (this.hasAttribute("disabled") || this.hasAttribute("checked"))
            return;
...
NptRadio.observedAttributes = ["checked", "disabled", "name", "value"];
...
NptSwitch.observedAttributes = ["checked", "disabled", "label"];
...
NptSlider.observedAttributes = ["min", "max", "value", "step", "disabled", "label"];
