> Historical first-edition documentation. Version and registry statements below are preserved history; use [Odyssey 3 adoption](https://github.com/neptune-ly/neptune_odyssey/blob/main/ODYSSEY_3.md) for current release status.
...
> **Neptune Odyssey Community License v1.0** ([`LICENSE`](https://github.com/neptune-ly/neptune_odyssey/blob/main/LICENSE)): free for non-commercial
...
| [`apps/configurator`](https://github.com/neptune-ly/neptune_odyssey/blob/main/apps/configurator) | Client-only theme builder (brandprint encode/decode + live preview + AA check) | **Stable** |
| [`apps/neptune_studio`](https://github.com/neptune-ly/neptune_odyssey/blob/main/apps/neptune_studio) | Desktop GUI for the client-demo factory — drop a logo, tune levers, generate + run a branded demo | **Stable** · dev tool, not published |
| [`apps/neptune_desktop`](https://github.com/neptune-ly/neptune_odyssey/blob/main/apps/neptune_desktop) | Cross-platform (macOS/Windows) demo shell app | **Stable** · dev tool, not published |
...
See [`LICENSE`](https://github.com/neptune-ly/neptune_odyssey/blob/main/LICENSE) and [`NOTICE`](https://github.com/neptune-ly/neptune_odyssey/blob/main/NOTICE).
